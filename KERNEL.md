...
Whilst SHORK 486 itself is licensed under GPL 3.0 terms, the contents of `shork-486/patches/linux` is licensed under [GPL 2.0 terms](https://docs.kernel.org/process/license-rules.html) as they are derived from Linux kernel source code.
