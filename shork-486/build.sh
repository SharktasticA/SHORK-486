...
LUA_SRC="https://github.com/lua/lua.git"
LUA_VER="5.5.1"
...
trim_fat()
{
    ...
    if $INCLUDE_MIDNIGHT_CMDR; then
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/ada95.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/aspx.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/b.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/cabal.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/changelog.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/cobol.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/cs.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/css.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/cuda.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/cython.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/debian-changelog.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/debian-control.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/debian-description.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/debian-sources-list.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/dlink.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/d.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/eiffel.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/erlang.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/glsl.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/go.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/haskell.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/hive.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/html.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/idl.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/jal.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/java.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/kotlin.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/latex.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/mail.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/markdown.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/meson.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/ml.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/named.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/nemerle.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/octave.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/opencl.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/osl.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/pascal.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/perl.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/php.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/PKGBUILD.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/po.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/povray.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/procmail.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/properties.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/protobuf.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/puppet.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/r.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/ruby.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/rust.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/slang.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/smalltalk.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/spec.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/spice.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/swift.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/tcl.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/texinfo.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/toml.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/ts.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/tt.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/verilog.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/vhdl.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/xml.syntax"
        #sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/yaml.syntax"
        sudo rm -rf "${DESTDIR}/usr/share/mc/syntax/yum-repo.syntax"
    fi
