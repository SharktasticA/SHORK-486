...
| [KBD](https://git.kernel.org/pub/scm/linux/kernel/git/legion/kbd.git) & [console-data](https://packages.debian.org/trixie/console-data) | 2.10.0 & 1.12-9 | Keymaps pack | GPLv2 |
