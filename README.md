...
If you are using an Arch or Debian-based Linux, run `setup.sh` whilst in the `shorkmini` directory and answer any prompts given throughout the process. Script parameters are listed in the "Scripts" section of this readme that can be used to reduce the need for the aforementioned prompts.
