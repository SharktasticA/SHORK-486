...
Besides being something fun to try on old PCs, the SHORK project was founded on the belief that old PCs can still be useful to the right people, retrocomputing and gaming usage aside. SHORK 486 can be useful for lightweight desktop usage, SSH terminal usage, distraction-free typewriting ("writerdecks"), embedded applications, demonstrative use in academia/education, and as a technical demonstration of what old PCs and modern software targeted at them can actually still do! If SHORK can save just one more PC from the landfills, it has done its job.
...
* Linux kernel version (7.3-rc4, 7.2.7, 7.1.13 or 7.0.14)
...
* _Note: If enabled and making a custom build, the option to use GRUB 2.x instead of EXTLINUX offered later will be ignored._
